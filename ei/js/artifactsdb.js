...
goog.provide('proto.ei.ArtifactsDB.VirtueDB');
 ...
 * @constructor
 */
proto.ei.ArtifactsDB.VirtueDB = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.ei.ArtifactsDB.VirtueDB.repeatedFields_, null);
};
goog.inherits(proto.ei.ArtifactsDB.VirtueDB, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.ei.ArtifactsDB.VirtueDB.displayName = 'proto.ei.ArtifactsDB.VirtueDB';
}
...
proto.ei.ArtifactsDB.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    inventorySlotsNotUsedList: jspb.Message.toObjectList(msg.getInventorySlotsNotUsedList(),
    ...
    proto.ei.MissionInfo.toObject, includeInstance),
    virtueAfxDb: (f = msg.getVirtueAfxDb()) && proto.ei.ArtifactsDB.VirtueDB.toObject(includeInstance, f),
...
proto.ei.ArtifactsDB.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 3:
      ...
      msg.addInventorySlotsNotUsed(value);
      break;
    case 7:
    ...
    case 5:
      ...
      break;
    case 15:
      var value = new proto.ei.ArtifactsDB.VirtueDB;
      reader.readMessage(value,proto.ei.ArtifactsDB.VirtueDB.deserializeBinaryFromReader);
      msg.setVirtueAfxDb(value);
      break;
    case 8:
...
proto.ei.ArtifactsDB.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getInventorySlotsNotUsedList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      3,
      f,
  ...
  f = message.getVirtueAfxDb();
  if (f != null) {
    writer.writeMessage(
      15,
      f,
      proto.ei.ArtifactsDB.VirtueDB.serializeBinaryToWriter
    );
  }
...
proto.ei.ArtifactsDB.ActiveArtifactSet.prototype.getSlotsList = function() {
  return /** @type{!Array<!proto.ei.ActiveArtifactSlot>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.ei.ActiveArtifactSlot, 1));
};
...
proto.ei.ArtifactsDB.ActiveArtifactSet.prototype.addSlots = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.ei.ActiveArtifactSlot, opt_index);
};
 ...
 * @const
 */
proto.ei.ArtifactsDB.VirtueDB.repeatedFields_ = [1,2];
 ...
 * @return {!Object}
 */
proto.ei.ArtifactsDB.VirtueDB.prototype.toObject = function(opt_includeInstance) {
  return proto.ei.ArtifactsDB.VirtueDB.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.ei.ArtifactsDB.VirtueDB} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.ei.ArtifactsDB.VirtueDB.toObject = function(includeInstance, msg) {
  var f, obj = {
    inventoryItemsList: jspb.Message.toObjectList(msg.getInventoryItemsList(),
    proto.ei.ArtifactInventoryItem.toObject, includeInstance),
    artifactStatusList: jspb.Message.toObjectList(msg.getArtifactStatusList(),
    proto.ei.ArtifactsDB.CraftableArtifact.toObject, includeInstance),
    fuelingMission: (f = msg.getFuelingMission()) && proto.ei.MissionInfo.toObject(includeInstance, f),
    activeArtifacts: (f = msg.getActiveArtifacts()) && proto.ei.ArtifactsDB.ActiveArtifactSet.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.ei.ArtifactsDB.VirtueDB}
 */
proto.ei.ArtifactsDB.VirtueDB.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.ei.ArtifactsDB.VirtueDB;
  return proto.ei.ArtifactsDB.VirtueDB.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.ei.ArtifactsDB.VirtueDB} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.ei.ArtifactsDB.VirtueDB}
 */
proto.ei.ArtifactsDB.VirtueDB.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.ei.ArtifactsDB.VirtueDB.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.ei.ArtifactsDB.VirtueDB.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.ei.ArtifactsDB.VirtueDB} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.ei.ArtifactsDB.VirtueDB.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getInventoryItemsList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
 ...
 */
proto.ei.ArtifactsDB.VirtueDB.prototype.getInventoryItemsList = function() {
 ...
 * @return {!proto.ei.ArtifactsDB.VirtueDB} returns this
*/
proto.ei.ArtifactsDB.VirtueDB.prototype.setInventoryItemsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};
 ...
 */
proto.ei.ArtifactsDB.VirtueDB.prototype.addInventoryItems = function(opt_value, opt_index) {
 ...
 * @return {!proto.ei.ArtifactsDB.VirtueDB} returns this
 */
proto.ei.ArtifactsDB.VirtueDB.prototype.clearInventoryItemsList = function() {
  return this.setInventoryItemsList([]);
};


/**
 * repeated CraftableArtifact artifact_status = 2;
 * @return {!Array<!proto.ei.ArtifactsDB.CraftableArtifact>}
 */
proto.ei.ArtifactsDB.VirtueDB.prototype.getArtifactStatusList = function() {
  return /** @type{!Array<!proto.ei.ArtifactsDB.CraftableArtifact>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.ei.ArtifactsDB.CraftableArtifact, 2));
};
 ...
 * @return {!proto.ei.ArtifactsDB.VirtueDB} returns this
*/
proto.ei.ArtifactsDB.VirtueDB.prototype.setArtifactStatusList = function(value) {
 ...
 * @return {!proto.ei.ArtifactsDB.CraftableArtifact}
 */
proto.ei.ArtifactsDB.VirtueDB.prototype.addArtifactStatus = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.ei.ArtifactsDB.CraftableArtifact, opt_index);
};
 ...
 * @return {!proto.ei.ArtifactsDB.VirtueDB} returns this
 */
proto.ei.ArtifactsDB.VirtueDB.prototype.clearArtifactStatusList = function() {
  return this.setArtifactStatusList([]);
};


/**
 * optional MissionInfo fueling_mission = 3;
 * @return {?proto.ei.MissionInfo}
 */
proto.ei.ArtifactsDB.VirtueDB.prototype.getFuelingMission = function() {
  return /** @type{?proto.ei.MissionInfo} */ (
    jspb.Message.getWrapperField(this, proto.ei.MissionInfo, 3));
};
 ...
 * @return {!proto.ei.ArtifactsDB.VirtueDB} returns this
*/
proto.ei.ArtifactsDB.VirtueDB.prototype.setFuelingMission = function(value) {
 ...
 * @return {!proto.ei.ArtifactsDB.VirtueDB} returns this
 */
proto.ei.ArtifactsDB.VirtueDB.prototype.clearFuelingMission = function() {
 ...
 * @return {boolean}
 */
proto.ei.ArtifactsDB.VirtueDB.prototype.hasFuelingMission = function() {
  return jspb.Message.getField(this, 3) != null;
};


/**
 * optional ActiveArtifactSet active_artifacts = 13;
 * @return {?proto.ei.ArtifactsDB.ActiveArtifactSet}
 */
proto.ei.ArtifactsDB.VirtueDB.prototype.getActiveArtifacts = function() {
  return /** @type{?proto.ei.ArtifactsDB.ActiveArtifactSet} */ (
    jspb.Message.getWrapperField(this, proto.ei.ArtifactsDB.ActiveArtifactSet, 13));
};


/**
 * @param {?proto.ei.ArtifactsDB.ActiveArtifactSet|undefined} value
 * @return {!proto.ei.ArtifactsDB.VirtueDB} returns this
*/
proto.ei.ArtifactsDB.VirtueDB.prototype.setActiveArtifacts = function(value) {
 ...
 * @return {!proto.ei.ArtifactsDB.VirtueDB} returns this
 */
proto.ei.ArtifactsDB.VirtueDB.prototype.clearActiveArtifacts = function() {
  return this.setActiveArtifacts(undefined);
};
 ...
 * @return {boolean}
 */
proto.ei.ArtifactsDB.VirtueDB.prototype.hasActiveArtifacts = function() {
...
/**
 * repeated InventorySlot inventory_slots_NOT_USED = 3;
 * @return {!Array<!proto.ei.InventorySlot>}
 */
proto.ei.ArtifactsDB.prototype.getInventorySlotsNotUsedList = function() {
 ...
 * @return {!proto.ei.ArtifactsDB} returns this
*/
proto.ei.ArtifactsDB.prototype.setInventorySlotsNotUsedList = function(value) {
 ...
 */
proto.ei.ArtifactsDB.prototype.addInventorySlotsNotUsed = function(opt_value, opt_index) {
 ...
 * @return {!proto.ei.ArtifactsDB} returns this
 */
proto.ei.ArtifactsDB.prototype.clearInventorySlotsNotUsedList = function() {
  return this.setInventorySlotsNotUsedList([]);
};
...
proto.ei.ArtifactsDB.prototype.getActiveArtifactsDeprecatedList = function() {
  return /** @type{!Array<!proto.ei.ActiveArtifactSlot>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.ei.ActiveArtifactSlot, 7));
};
...
proto.ei.ArtifactsDB.prototype.addActiveArtifactsDeprecated = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 7, opt_value, proto.ei.ActiveArtifactSlot, opt_index);
};
...
/**
 * optional VirtueDB virtue_afx_db = 15;
 * @return {?proto.ei.ArtifactsDB.VirtueDB}
 */
proto.ei.ArtifactsDB.prototype.getVirtueAfxDb = function() {
  return /** @type{?proto.ei.ArtifactsDB.VirtueDB} */ (
    jspb.Message.getWrapperField(this, proto.ei.ArtifactsDB.VirtueDB, 15));
};


/**
 * @param {?proto.ei.ArtifactsDB.VirtueDB|undefined} value
 * @return {!proto.ei.ArtifactsDB} returns this
*/
proto.ei.ArtifactsDB.prototype.setVirtueAfxDb = function(value) {
 ...
 * @return {!proto.ei.ArtifactsDB} returns this
 */
proto.ei.ArtifactsDB.prototype.clearVirtueAfxDb = function() {
  return this.setVirtueAfxDb(undefined);
};
 ...
 * @return {boolean}
 */
proto.ei.ArtifactsDB.prototype.hasVirtueAfxDb = function() {
