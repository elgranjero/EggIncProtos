...
goog.forwardDeclare('proto.ei.GameDimension');
/**
...
proto.ei.GameModifier.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    valueModifier: (f = jspb.Message.getOptionalFloatingPointField(msg, 2)) == null ? undefined : f,
...
proto.ei.GameModifier.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = /** @type {!proto.ei.GameDimension} */ (reader.readEnum());
      msg.setDimension(value);
      break;
    case 2:
      var value = /** @type {number} */ (reader.readDouble());
      msg.setValueModifier(value);
      break;
    case 3:
...
proto.ei.GameModifier.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = /** @type {!proto.ei.GameDimension} */ (jspb.Message.getField(message, 1));
  if (f != null) {
    writer.writeEnum(
      1,
      f
 ...
 * @return {!proto.ei.GameDimension}
 */
proto.ei.GameModifier.prototype.getDimension = function() {
  return /** @type {!proto.ei.GameDimension} */ (jspb.Message.getFieldWithDefault(this, 1, 1));
};


/**
 * @param {!proto.ei.GameDimension} value
...
/**
 * optional double value_modifier = 2;
 * @return {number}
 */
proto.ei.GameModifier.prototype.getValueModifier = function() {
 ...
 * @return {!proto.ei.GameModifier} returns this
 */
proto.ei.GameModifier.prototype.setValueModifier = function(value) {
 ...
 * @return {!proto.ei.GameModifier} returns this
 */
proto.ei.GameModifier.prototype.clearValueModifier = function() {
 ...
 * @return {boolean}
 */
proto.ei.GameModifier.prototype.hasValueModifier = function() {
