...
proto.ei.ConfigRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    ageComplianceStatus: (f = jspb.Message.getField(msg, 9)) == null ? undefined : f
  };
...
proto.ei.ConfigRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  f = /** @type {!proto.ei.AgeComplianceStatus} */ (jspb.Message.getField(message, 9));
  if (f != null) {
    writer.writeEnum(
      9,
      f
...
/**
 * optional AgeComplianceStatus age_compliance_status = 9;
 * @return {!proto.ei.AgeComplianceStatus}
 */
proto.ei.ConfigRequest.prototype.getAgeComplianceStatus = function() {
  return /** @type {!proto.ei.AgeComplianceStatus} */ (jspb.Message.getFieldWithDefault(this, 9, 0));
};
 ...
 * @return {!proto.ei.ConfigRequest} returns this
 */
proto.ei.ConfigRequest.prototype.setAgeComplianceStatus = function(value) {
 ...
 * @return {!proto.ei.ConfigRequest} returns this
 */
proto.ei.ConfigRequest.prototype.clearAgeComplianceStatus = function() {
 ...
 * @return {boolean}
 */
proto.ei.ConfigRequest.prototype.hasAgeComplianceStatus = function() {
