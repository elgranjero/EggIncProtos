 ...
 * @const
 */
proto.ei.ContractsResponse.repeatedFields_ = [1,6];
 ...
 */
proto.ei.ContractsResponse.prototype.getCustomEggsList = function() {
  return /** @type{!Array<!proto.ei.CustomEgg>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.ei.CustomEgg, 6));
};
 ...
 * @return {!proto.ei.ContractsResponse} returns this
*/
proto.ei.ContractsResponse.prototype.setCustomEggsList = function(value) {
 ...
 */
proto.ei.ContractsResponse.prototype.addCustomEggs = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 6, opt_value, proto.ei.CustomEgg, opt_index);
};
 ...
 * @return {!proto.ei.ContractsResponse} returns this
 */
proto.ei.ContractsResponse.prototype.clearCustomEggsList = function() {
